defmodule AppWeb.Auth.Overrides do
  ...
  override Components.Banner do
    ...
    set :image_url,
        "https://media.istockphoto.com/vectors/heart-of-coffee-beans-vector-illustration-in-flat-style-vector-id1144792637?k=20&m=1144792637&s=612x612&w=0&h=qZ2i9NG7h7xZlimsKlCSzE_vxtYhqhlKEpAoGbFJZpM="
  ...
  override Components.Password do
    ...
    set :toggler_class, "flex-none text-theme-600 hover:text-theme-700 px-2 first:pl-0 last:pr-0"
  ...
  override Components.Password.Input do
    ...
    shadow-sm placeholder-gray-400 focus:outline-none focus:ring-theme-pale-500
    focus:border-theme-pale-500 sm:text-sm dark:text-black
    """
    ...
    shadow-sm text-sm font-medium text-white bg-theme-600 hover:bg-theme-700
    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-600
    mt-4 mb-4
    """
